...
public enum EnergyTypesEnum {
    ACTIVE_COMSUMED_1("t_data_active_energy_1_consumed"),
    ACTIVE_COMSUMED_2("t_data_active_energy_2_consumed"),
    ACTIVE_COMSUMED_3("t_data_active_energy_3_consumed"),
    ...
    REACTIVE_COMSUMED_1("t_data_reactive_energy_1_consumed"),
    REACTIVE_COMSUMED_2("t_data_reactive_energy_2_consumed"),
    REACTIVE_COMSUMED_3("t_data_reactive_energy_3_consumed"),
